        ...
        <main className="lg:col-span-8">
          ...
          {isSubmitted ? (
            ...
            <>
              ...
              <div className="bg-yellow-50 p-5 rounded-2xl mb-8 border-l-4 border-amber-400 text-yellow-900 shadow-md">
                <p className="flex items-start gap-4">
                  <i className="fas fa-info-circle text-amber-400 mt-1 text-xl"></i>
                ...
                <FormSection title="ডকুমেন্ট ও ছবি আপলোড" iconClass="fa-cloud-upload">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                   ...
                   <div className="bg-teal-50 p-6 rounded-2xl mt-6 border-l-4 border-teal-500 text-center">
                    <h3 className="text-xl font-bold text-emerald-900 flex items-center justify-center gap-3"><i className="fas fa-robot"></i> স্বয়ংক্রিয় তথ্য পূরণ</h3>
                    <p className="text-teal-800 mt-2 mb-4 font-sans">NID আপলোডের পর এই বাটনে ক্লিক করুন।</p>
                    <button onClick={handleAutoFill} disabled={isProcessing || !frontNid || !backNid} className="w-full sm:w-auto bg-emerald-900 text-white py-3 px-8 rounded-full font-bold font-sans flex items-center justify-center gap-3 transition-all duration-300 transform hover:-translate-y-1 shadow-lg hover:shadow-xl hover:bg-emerald-800 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-md">
                  ...
                  <div className="mt-6">
                    ...
                    <textarea id="additionalInfo" rows={4} value={formData.additionalInfo} onChange={handleInputChange} placeholder="অন্যান্য মন্তব্য..." className="w-full p-4 border-2 border-gray-200 rounded-xl focus:ring-2 focus:ring-amber-400 focus:border-transparent transition bg-gray-50 font-sans"></textarea>
                  </div>
                </FormSection>
              </div>

              <div className="text-center mt-12">
                <button onClick={handleSubmit} className="bg-amber-400 text-emerald-900 py-4 px-12 text-xl font-bold font-display tracking-wider rounded-full shadow-xl transition-all duration-300 transform hover:-translate-y-1.5 hover:shadow-2xl hover:brightness-105 focus:outline-none focus:ring-4 focus:ring-yellow-300">
